# Lancarkode game #001
# Title     : Shoot Factor!!! - V15
# Author    : Patuan P. T.
# Date      : 11/04/21

#################
# In this version, we will get 3 random numbers from 2 to 50
# those numbers will be the asteroids hardness
# we will import the new library which is random
#################
