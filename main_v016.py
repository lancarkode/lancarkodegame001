...
#################
# In this version, we will add space background from our Assets
# See how I cropped the space image to fit in the screen
# Instead of using BLUE, let use GREEN to make our planet liveable
#################
