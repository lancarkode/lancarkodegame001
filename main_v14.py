# Lancarkode game #001
# Title     : Shoot Factor!!! - V14
# Author    : Patuan P. T.
# Date      : 11/04/21

#################
# In this version, we will fix the shown hardness point in the box
# when the main character aiming a certain asteroid, we want that its the hardness point to be shown
# the idea is we will use a very long rectangle to reach the asteroids rectangle
# the rectangle will follow the movement of the main character
# pay attention in character_move() and main()
# when the rectangle is collide with the asteroid we will show its hardness
#################
