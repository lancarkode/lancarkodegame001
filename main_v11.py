# Lancarkode game #001
# Title     : Shoot Factor!!! - V11
# Author    : Patuan P. T.
# Date      : 11/04/21

#################
# In this version, you will learn how to use collide rectangular
# This is the part two of the fire shooting step
# The idea is when the bullet is collide with the asteroids, the bullet will be removed from screen
# as the bullet is impacting the hardness of the asteroids
# pay attention to bullet_shoot() and the main()
#################
...
def bullet_shoot(bullet_list, asteroid_one, asteroid_two, asteroid_three):
    for one_bullet in bullet_list:
        ...
        if asteroid_one.colliderect(one_bullet):  # this the way we use collide rectangular
            bullet_list.remove(one_bullet)
        elif asteroid_two.colliderect(one_bullet):  # this the way we use collide rectangular
            bullet_list.remove(one_bullet)
        elif asteroid_three.colliderect(one_bullet):  # this the way we use collide rectangular
            bullet_list.remove(one_bullet)
