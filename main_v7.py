# Lancarkode game #001
# Title     : Shoot Factor!!! - V7
# Author    : Patuan P. T.
# Date      : 11/04/21

#################
# In this version, we move the object
# First we set the Frame rate which is FPS to be 30
# We use clock function for controlling the FPS
# Then we set the velocity of each object
# All the object coordinate now will be different.
# They are not static. To move them, we change the coordinate in each frame
# Please pay attention in the main_game() and screen_draw()
#################
...
# for this example, we only move the character downward
# pay attention to the y coordinate
def character_move(character_object):
    if character_object.y >= 0:
