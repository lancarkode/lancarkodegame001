# Lancarkode game #001
# Title     : Shoot Factor!!! - V13
# Author    : Patuan P. T.
# Date      : 11/04/21

#################
# In this version, you will learn how to show a text in the game using pygame
# We will show the number of the bullet point in the bullet box
# We will show one of the hardness of the asteroid in the Hardness point box
#################
